...
public class PostController {
     ...
     */
    public void addPost(int POST_ID, String POST_TEXT, int POST_COMMENT_NUM, int POST_LIKE_NUM, String POST_PRIVACY, String USER_ID){
        ...
        Document post = new Document("POST_ID", newPost.getPOST_ID())
                ...
                .append("Text", newPost.getPOST_TEXT())
